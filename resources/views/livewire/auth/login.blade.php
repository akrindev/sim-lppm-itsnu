    ...
    <div class="page page-center">
        <div class="py-4 container container-normal">
                        ...
                        <div class="card card-md">
                            <div class="card-body">
                                ...
                                @if (app()->environment('local'))
                                    <div class="hr-text">Development Login</div>
                                    <div class="row g-2 mb-3">
                                        @foreach (['superadmin', 'admin lppm', 'kepala lppm', 'dekan', 'dosen', 'reviewer', 'rektor'] as $role)
                                            <div class="col-6">
                                                <button type="button" class="btn w-100"
                                                    wire:click="devLogin('{{ $role }}')">
                                                    {{ Str::title($role) }}
                                                </button>
                                            </div>
                                        @endforeach
