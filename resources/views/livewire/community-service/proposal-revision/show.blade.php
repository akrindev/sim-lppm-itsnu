                                                            ...
                                                            <table class="table table-sm table-borderless bg-white rounded border mb-0" style="font-size: 8pt;">
                                                                <thead class="bg-light">
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center py-1">Skor</th>
                                                                        <th class="text-end py-1">Nilai</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    @foreach($log->scores as $ls)
                                                                        <tr>
                                                                            <td class="py-1">{{ $ls->criteria->criteria }}</td>
                                                                            <td class="text-center py-1">{{ $ls->score }}</td>
                                                                            <td class="text-end py-1 fw-bold">{{ number_format($ls->value, 0) }}</td>
                                                                        </tr>
                                                                    @endforeach
                                                                </tbody>
                                                            </table>
