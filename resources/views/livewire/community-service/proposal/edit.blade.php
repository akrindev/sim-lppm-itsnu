...
<div>
    ...
    <form wire:submit.prevent="save" novalidate>
        ...
        <!-- Add Member Modal -->
        @teleport('body')
            <x-tabler.modal id="modal-add-member" title="Tambah Anggota Pengabdi" :component-id="$componentId"
                ...
                <x-slot:body>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="member_tugas" class="form-control @error('member_tugas') is-invalid @enderror"
                            wire:model.live="member_tugas" rows="3" placeholder="Jelaskan tugas anggota dalam pengabdian ini"
