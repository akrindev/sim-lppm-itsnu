...
<div class="row" x-data="{ currentStep: {{ auth()->user()->hasRole('reviewer') ? 5 : 1 }} }">
    ...
    <div class="col-md-12">
        ...
        <div id="section-identitas" x-show="currentStep === 1">
            @include('livewire.community-service.proposal.components.identitas-usulan', [
                'proposal' => $proposal,
            ])
        ...
        <div id="section-substansi" x-show="currentStep === 2">
            @include('livewire.community-service.proposal.components.substansi-usulan', [
                'proposal' => $proposal,
            ])
        </div>
        ...
        <div id="section-workflow" x-show="currentStep === 5">
            <div class="row g-3 mt-4">
                <div class="col-12 col-lg-8 order-lg-1 order-2">
                    @include('livewire.community-service.proposal.components.workflow-actions', [
                        'proposal' => $proposal,
                    ])
