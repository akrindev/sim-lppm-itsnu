...
<x-slot:pageActions>
    <div class="btn-list">
        ...
        @if ($proposal->status->value === 'draft' && $proposal->submitter_id === auth()->id())
            <a href="{{ route('community-service.proposal.edit', $proposal) }}" wire:navigate.hover class="btn btn-primary">
            ...
            <div class="d-flex">
                ...
                <div>
                    ...
                    @elseif($role === 'dekan')
                        ...
                        <div class="text-secondary">
                            Tugas Anda adalah memvalidasi usulan PKM dari fakultas Anda. Periksa keterlibatan mitra dan relevansi solusi yang ditawarkan. 
                            Berikan keputusan Anda melalui menu persetujuan di <strong>Tab #5</strong>.
                        </div>
                    @elseif($role === 'admin')
                        <h4 class="alert-title">Panduan Admin LPPM</h4>
                        <div class="text-secondary">
                            Periksa kelengkapan dokumen kesanggupan mitra di <strong>Tab #4</strong>. 
                            Tugaskan reviewer yang memiliki kompetensi sesuai dengan bidang usulan pada <strong>Tab #5</strong>.
                        </div>
                    @elseif($role === 'kepala')
