            ...
            <div class="card-body">
                <ul class="my-4 steps steps-green steps-counter">
                    <li class="step-item active">
                        <a href="#section-identitas" class="text-decoration-none">Identitas Usulan</a>
                    </li>
                    <li class="step-item">
                        <a href="#section-substansi" class="text-decoration-none">Substansi Usulan</a>
                    </li>
                    <li class="step-item">
                        <a href="#section-rab" class="text-decoration-none">RAB</a>
                    </li>
                    <li class="step-item">
                        <a href="#section-dokumen" class="text-decoration-none">Dokumen Pendukung</a>
                    </li>
                    <li class="step-item">
                        <a href="#section-workflow" class="text-decoration-none">Workflow & Aksi</a>
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <tbody>
                                    @foreach ($proposal->teamMembers as $member)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-{{ $member->pivot->status === 'accepted' ? 'success' : 'warning' }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            @if ($research?->substance_file)
                                <p>
                                    <a href="{{ Storage::url($research->substance_file) }}" target="_blank" class="btn-outline-primary btn btn-sm">
                                ...
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th>Rp {{ number_format($proposal->budgetItems->sum('total_price'), 2, ',', '.') }}</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-1 text-muted">
                                                    @if ($partner->institution)
                                                        <x-lucide-building class="icon-inline icon" /> {{ $partner->institution }}
                                                    @endif
                                                    @if ($partner->country)
                                                        <x-lucide-map-pin class="icon-inline ms-2 icon" /> {{ $partner->country }}
                                                    @endif
                                                </p>
                                                @if ($partner->email)
                                                ...
                                                @if ($partner->commitment_letter_file)
                                                    <div class="mt-2">
                                                        <a href="{{ Storage::url($partner->commitment_letter_file) }}" target="_blank" class="btn-outline-primary btn btn-sm">
                                                            <x-lucide-download class="icon" />
                                                            Surat Kesanggupan
                                                        </a>
                                                    </div>
                                    ...
                                    <tbody>
                                        @foreach ($reviewers as $reviewer)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-{{ $reviewer->status === 'completed' ? 'success' : 'warning' }}">
