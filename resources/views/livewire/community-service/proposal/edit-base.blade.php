    ...
    <form wire:submit.prevent="save" novalidate>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input id="title" type="text"
                                ...
                                placeholder="Masukkan judul proposal pengabdian" required>
                            @error('form.title')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input id="sbk_value" type="number" step="0.01"
                                ...
                                wire:model="form.sbk_value" placeholder="0.00" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select id="national_priority"
                                ...
                                wire:model="form.national_priority_id"
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <select id="partner_id"
                        ...
                        wire:model="form.partner_id" placeholder="Pilih mitra pengabdian (opsional)">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="partner_issue_summary" class="form-control @error('form.partner_issue_summary') is-invalid @enderror"
                        wire:model="form.partner_issue_summary" rows="5"
                ...
                <div class="mb-3">
                    ...
                    <textarea id="solution_offered" class="form-control @error('form.solution_offered') is-invalid @enderror"
                        wire:model="form.solution_offered" rows="5"
                ...
                <div class="mb-3">
                    ...
                    <textarea id="methodology" class="form-control @error('form.methodology') is-invalid @enderror"
                        wire:model="form.methodology" rows="5" placeholder="Jelaskan metodologi pengabdian (minimal 200 karakter)"
                        required></textarea>
        ...
        <div class="mb-3 card">
            <div class="card-body">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <h3 class="mb-0 card-title">Tugas Ketua Pengabdi</h3>
                </div>

                <div class="mb-3">
                    <label class="form-label">Ketua Pengabdi</label>
                    <input type="text" class="form-control @error('author_name') is-invalid @enderror"
                        wire:model="author_name" placeholder="Nama Ketua Pengabdi" required disabled />
                    @error('author_name')
                        <div class="d-block invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    <label class="form-label" for="ketua_tasks">Jelaskan tugas ketua pengabdi dalam pengabdian ini
                        <span class="text-danger">*</span></label>
                    <textarea id="ketua_tasks" class="form-control @error('form.author_tasks') is-invalid @enderror"
                        wire:model="form.author_tasks" rows="3" placeholder="Jelaskan tugas ketua pengabdi dalam pengabdian ini"
                        required></textarea>
        ...
        <div class="mb-3 card">
            <div class="card-body">
                ...
                <livewire:forms.team-members-form :members="$form->members" modal-title="Tambah Anggota Pengabdi"
