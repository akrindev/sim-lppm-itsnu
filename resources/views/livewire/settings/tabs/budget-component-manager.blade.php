                            ...
                            <td>
                                <div class="btn-list">
                                    ...
                                    <button type="button" class="btn-outline-danger btn btn-sm"
                                        data-bs-toggle="modal" data-bs-target="#modal-confirm-delete-budget-component" wire:click="confirmDelete({{ $item->id }})">
                                        Hapus
                                    </button>
                                </div>
                            </td>
...
<x-tabler.modal-confirmation
        ...
        />
<x-tabler.modal id="modal-budget-component" :title="$modalTitle" onHide="resetForm">
            <x-slot:body>
