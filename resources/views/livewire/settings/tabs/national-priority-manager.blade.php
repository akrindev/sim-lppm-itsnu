<div>
    <div class="card">
        <div class="d-flex align-items-center justify-content-between card-header">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-national-priority">
    ...
    @teleport('body')
        <x-tabler.modal id="modal-national-priority" :title="$modalTitle">
            <x-slot:body>
        ...
        <script>
            document.addEventListener('livewire:init', () => {
                const modal = document.getElementById('modal-national-priority');
                if (modal) {
