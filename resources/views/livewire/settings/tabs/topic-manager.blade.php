<div>
    ...
    <div class="card">
        <div class="d-flex align-items-center justify-content-between card-header">
            ...
            <button type="button" class="btn btn-primary" wire:click='create' data-bs-toggle="modal" data-bs-target="#modal-topic">
                            ...
                            <td>
                                <div class="btn-list">
                                    <button type="button" class="btn-outline-warning btn btn-sm"
                                        wire:click="edit('{{ $item->id }}')" data-bs-toggle="modal" data-bs-target="#modal-topic">
                                        Edit
                                    </button>
...
<x-tabler.modal-confirmation
            wire:key="modal-confirm-delete-topic"
            id="modal-confirm-delete-topic"
        ...
        />
<x-tabler.modal wire:key="modal-topic" id="modal-topic" :title="$modalTitle" onHide="resetForm" component-id="{{ $this->getId() }}">
            <x-slot:body>
            ...
            <x-slot:footer>
                ...
                <button type="submit" form="form-topic" class="btn btn-primary" wire:loading.class="btn-loading" wire:target="save">Simpan</button>
            </x-slot:footer>
        </x-tabler.modal>
@endteleport
</div>
