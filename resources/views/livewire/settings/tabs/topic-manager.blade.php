                            ...
                            <td>
                                <div class="btn-list">
                                    ...
                                    <button type="button" class="btn-outline-danger btn btn-sm"
                                        data-bs-toggle="modal" data-bs-target="#modal-confirm-delete-topic" wire:click="confirmDelete('{{ $item->id }}')">
                                        Hapus
                                    </button>
                                </div>
                            </td>
...
<x-tabler.modal-confirmation
        ...
        />
<x-tabler.modal id="modal-topic" :title="$modalTitle" onHide="resetForm">
            <x-slot:body>
