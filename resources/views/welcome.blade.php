...
<head>
    ...
    <title>ITSNU Pekalongan LPPM</title>
...
<body class="body-marketing body-gradient">
    ...
    <script src="../dist/js/tabler-theme.min.js?1760227346"></script>
    <!-- END GLOBAL THEME SCRIPT -->
    <header class="py-3 navbar navbar-expand-lg navbar-transparent">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <nav class="ms-auto navbar-nav">
                    <div class="nav-item">
                        <a class="nav-link active" href="../marketing"><span class="nav-link-title">Beranda</span></a>
                    </div>
                    <div class="nav-item">
                        <a class="nav-link" href="../marketing/testimonials.html"><span
                                class="nav-link-title">Testimoni</span></a>
                    </div>
                    <div class="nav-item">
                        <a class="nav-link" href="../marketing/pricing.html"><span
                                class="nav-link-title">Informasi</span></a>
                    </div>
                    <div class="nav-item">
                        <a class="nav-link" href="../marketing/about.html"><span class="nav-link-title">Tentang</span></a>
                    </div>
                    <div class="nav-item">
                        <a class="nav-link" href="../marketing/text.html"><span class="nav-link-title">Dokumentasi</span></a>
                    </div>
                    <div class="nav-item">
                        <a class="nav-link" href="../marketing/hero.html"><span class="nav-link-title">Aplikasi</span></a>
                    </div>
                    <div class="ms-4 nav-item">
    ...
    <header class="pb-0 hero">
        <div class="container">
            <h1 class="hero-title">Sistem Informasi Manajemen Penelitian dan Pengabdian kepada Masyarakat</h1>
            <p class="mt-4 hero-description">
                SIM PPM — platform terpusat untuk mengelola hibah penelitian dan pengabdian kepada masyarakat di ITS NU Pekalongan.
                Mempercepat pengajuan, penilaian, pelaporan, dan pengawasan dengan akses berbasis peran.
            </p>
            <div class="my-5">
                <div class="justify-content-center row g-3">
                    <div class="col-auto">
                        <a href="#" class="btn btn-lg">Lihat Fitur</a>
                    </div>
                    <div class="col-auto">
                        <a href="#" class="btn btn-lg btn-primary" target="_blank" rel="noopener noreferrer">Pratinjau</a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-8">
                                <a href="https://preview.tabler.io" class="browser-input" target="_blank"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        stroke-linejoin="round" class="me-2 text-green icon icon-sm">
                                        <path
    ...
    <section class="mt-n12 pt-12 section section-light">
        ...
        <div class="container">
            <div class="mb-6 section-header">
                <h2 class="text-secondary section-title">Trusted by over 3,000 companies</h2>
            </div>
            <div class="align-items-center justify-content-center row g-lg-8">
                <div class="col-auto">
    ...
    <section class="section">
        <div class="container">
            <div class="items-center text-center row g-lg-10">
                <div class="col-md-6 col-lg">
                    <div class="mb-3 shape shape-md">
                    ...
                    <div class="space-y-6">
                        <div>
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="mb-2 h2">Designed with users in mind</h3>
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="mb-2 h2">Built for developers</h3>
                                    <p class="m-0 text-secondary">
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="mb-2 h2">Fully customizable</h3>
                                    <p class="m-0 text-secondary">
    ...
    <section class="section">
        <div class="text-center container-narrow">
            ...
            <div class="justify-content-center mt-6 btn-list">
                            ...
                            <a href="#" class="bg-surface-secondary card">
                                <div class="card-body">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col">
                                            <h3 class="m-0 h3">Mallory Hulme</h3>
                            ...
                            <a href="#" class="bg-surface-secondary card">
                                <div class="card-body">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col">
                                            <h3 class="m-0 h3">Maryjo Lebarree</h3>
                            ...
                            <a href="#" class="bg-surface-secondary card">
                                <div class="card-body">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col">
                                            <h3 class="m-0 h3">Kellie Skingley</h3>
                            ...
                            <a href="#" class="bg-surface-secondary card">
                                <div class="card-body">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col">
                                            <h3 class="m-0 h3">Christabel Charlwood</h3>
                            ...
                            <a href="#" class="bg-surface-secondary card">
                                <div class="card-body">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col">
                                            <h3 class="m-0 h3">Haskel Shelper</h3>
            ...
            <div class="justify-content-lg-center row">
                <div class="col-sm-6 col-lg-3">
                    <div class="text-center">
                        <h2 class="m-0 display-5 fw-bold">48</h2>
                        <p class="m-0 text-secondary">template</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="text-center">
                        <h2 class="m-0 display-5 fw-bold">12</h2>
                        <p class="m-0 text-secondary">tahun beroperasi</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="text-center">
                        <h2 class="m-0 display-5 fw-bold">2,5k+</h2>
                        <p class="m-0 text-secondary">instalasi</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="text-center">
                        <h2 class="m-0 display-5 fw-bold">99%</h2>
                        <p class="m-0 text-secondary">kepuasan pengguna</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section">
        <div class="container">
            <div class="mb-6 section-header">
                <h2 class="section-title">Berlangganan informasi LPPM</h2>
                <p class="section-description">Dapatkan pengumuman siklus pengajuan, tenggat waktu, dan informasi penting lainnya.
                </p>
            </div>
        </div>
        <div class="container-tight">
            <div class="row">
                <div class="col">
                    <input class="w-100 form-control" placeholder="Email Anda" type="email" />
                </div>
                <div class="col-auto">
    ...
    <section class="section section-light">
        <div class="container">
            <div class="row g-xl-6">
                <div class="col-lg-4">
                    <div class="sticky-top text-start section-header">
                        <div class="section-title">Pertanyaan yang Sering Diajukan</div>
                        <p class="section-description">Tidak menemukan jawaban? Hubungi tim TI Universitas atau LPPM.</p>
                    </div>
                </div>
                <div class="col-lg">
                    <div class="space-y-5">
                        <div>
                            <div class="mb-1 h3">Apakah sistem ini dapat digunakan untuk keperluan institusi?</div>
                            <div class="text-secondary">
                                Ya. SIM PPM dirancang untuk penggunaan institusional oleh ITS NU Pekalongan dan unit terkait.
                            </div>
                        </div>
                        <div>
                            <div class="mb-1 h3">Bagaimana cara menerima notifikasi pembaruan sistem?</div>
                            <div class="text-secondary">Notifikasi akan disampaikan melalui email institusional dan pengumuman di dashboard LPPM.</div>
                        </div>
                        <div>
                            <div class="mb-1 h3">Siapa yang harus dihubungi jika menemukan masalah atau bug?</div>
                            <div class="text-secondary">
                                Hubungi tim IT Universitas (helpdesk) atau tim pengembang proyek yang ditunjuk oleh LPPM.
                            </div>
                        </div>
                    </div>
                    <div class="mt-5">
            ...
            <div class="py-3">
                <div class="row g-lg-4">
                    <div class="col-lg-7">
                        <div class="row g-lg-4">
                            <div class="col-md">
                                <div class="mb-3 subheader">Our products</div>
                                <ul class="gap-2 list-separated list-unstyled">
                            ...
                            <div class="col-md">
                                <div class="mb-3 subheader">Support</div>
                                <ul class="gap-2 list-separated list-unstyled">
                            ...
                            <div class="col-md">
                                <div class="mb-3 subheader">Tabler</div>
                                <ul class="gap-2 list-separated list-unstyled">
                                    <li><a class="link-secondary" href="">About</a></li>
                                    <li><a class="link-secondary" href="">Blog</a></li>
                                    <li><a class="link-secondary" href="">Changelog</a></li>
                                    <li>
                                        <a href="https://github.com/tabler/tabler" class="link-secondary"
                    ...
                    <div class="ml-auto col-lg-4">
                        <div class="text-secondary">
                            SIM PPM menyediakan modul dan komponen yang dirancang untuk kebutuhan LPPM. Mulai gunakan
                            sistem untuk meningkatkan efisiensi dan transparansi pengelolaan hibah.
                        </div>
                    </div>
                </div>
                <div class="justify-content-between mt-0 mt-md-2 row g-lg-4">
                    ...
                    <div class="text-sm-end col-sm-5 col-md-6 col-lg-3">
    ...
    <footer class="footer">
        <div class="container">
            <div class="py-3 border-top-light text-lg-start text-center">
                <div class="row g-lg-4">
                    <div class="order-lg-last text-lg-end col-lg-auto">
                    ...
                    <div class="col-lg">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="icon-inline text-red icon icon-4">
                            <path d="M19.5 12.572l-7.5 7.428l-7.5 -7.428a5 5 0 1 1 7.5 -6.566a5 5 0 1 1 7.5 6.572" />
                        </svg>
                        di ITS NU Pekalongan.
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="/dist/js/tabler.min.js?1760227347" defer></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <!-- BEGIN DEMO SCRIPTS -->
    {{-- <script src="/preview/js/demo.min.js?1760227347" defer></script> --}}
    <!-- END DEMO SCRIPTS -->
    <!-- BEGIN PAGE SCRIPTS -->
    <script>
