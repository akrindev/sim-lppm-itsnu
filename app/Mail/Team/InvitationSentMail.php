...
class InvitationSentMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: "[SIM LPPM] Undangan Menjadi Anggota Tim - {$this->proposal->title}",
        );
    }
